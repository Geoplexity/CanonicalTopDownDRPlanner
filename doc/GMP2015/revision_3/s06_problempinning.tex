...
\begin{definition}
    A \dfn{body-hyperpin qusecs} is a constraint system where the objects are rigid bodies,  subsets of which are pinned together by pins; i.e, are incident at a common point.
\end{definition}
