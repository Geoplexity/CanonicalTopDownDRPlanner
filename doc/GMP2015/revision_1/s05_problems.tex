...
\label{sec:table}
In this section we provide a unified view of  the various problems studied in the previous 2 sections, along with formal reductions between them, and relationships to other known problems and results as well as open questions.
%
...
We discuss the complexity of the restricted OMD problem (when $k$ is part of the input) in \ref{sec:futurework}.
