...
In the following, we formulate the problem of \dfn{optimal modification}\cutout{,} of the indecomposable algebraic system $I$ into a decomposable system with a small DR-plan (low algebraic complexity). Leveraging recent results on \dfn{Cayley configuration spaces}, our approach to the optimal modification problem achieves the following:
...
\notetoreviewer{The following proof was moved in from the appendix.}
