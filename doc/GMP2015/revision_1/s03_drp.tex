...
This proof of this theorem relied on the following crucial observation and lemma that are also used for other types of qusecs in the \cutout{A}\addin{a}pplication sections (\ref{sec:bodypin} and \ref{sec:pinnedline}) of the paper.
