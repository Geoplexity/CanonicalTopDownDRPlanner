...
\begin{enumerate}
    \item If $F_i\cup F_j$ were trivial, then $F_i$ and $F_j$ must be trivial, by definition.

    \item Observe that under-constrained subgraphs of well-constrained graphs must have density less than $k$. Then it is straightforward application of the equation above.
