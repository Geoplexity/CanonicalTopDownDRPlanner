...
% \begin{proof}
% Immediate from Lemma \ref{lemma:main_trivial} and \ref{lemma:main_wellconstrained}.
% \end{proof}



% \begin{lemma}\label{lemma:main_trivial}
...
% \begin{lemma}\label{lemma:main_wellconstrained}
...
\subsubsection{Proving the Main Theorem \ref{theorem:main}}
