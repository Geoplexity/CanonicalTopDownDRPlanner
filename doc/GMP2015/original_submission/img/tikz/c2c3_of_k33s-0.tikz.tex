...
\begin{tikzpicture}[scale=2]
    ...
    \node[c] (v2) at (-1,-0.866) [label={below,inner sep=.555}:$b_1$]{};
    \node[c] (v3) at (1,-0.866) [label={right,inner sep=.555}:$c_1$]{};

    \node[c] (v4) at (0,0.433-.125) [label={left,inner sep=.555}:$a_2$]{};
    \node[c] (v5) at (-0.5,-0.433-.125) [label={below,inner sep=.555}:$b_2$]{};
    \node[c] (v6) at (0.5,-0.433-.125) [label={right,inner sep=.555}:$c_2$]{};
