...
and the smallest over-constrained graph has $6$ vertices. 
...
%\end{itemize}
%
We make the following corresponding modification to the definition of the DR-plan:
...
\begin{definition}
 ...
 each child node of a non-leaf node $C$ is either an edge not contained in any well-constrained proper subgraph of $C$, or a {\em connected} well-constrained vertex-maximal proper subgraph of  $C$.
...
\noindent {\bf Note:} The recombination problem for  pinned line-incidence systems is trivial.
