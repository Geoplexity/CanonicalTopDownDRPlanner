...
by modeling these structures as {\it pinned line incidence systems}.

{\it Collagen} is an important protein material in biological tissues with highly elastic mechanical property.
{\it Cellulose} is the most important constituent of the cell wall of plants (see Figure~\ref{fig:cellulose}).
Both of these substances consist of a large number {\it microfibrils},
...
where the {\it  cross-linking} is like an incidence constraint that
