...
\item 
\todo{We just define the trivial graph/DR-plan leaf for 2-dimensional pinned line incidence graphs to be a single vertex.  }
...
and they go through for 2-dimensional pinned line incidence as well. }
