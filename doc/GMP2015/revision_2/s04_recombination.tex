...
We now briefly survey existing techniques for handling the complexity of recombination of 2D DR-plans. The limitations of these techniques directly motivate the contributions in this section.

\begin{enumerate}
    \item
    \header{Optimal Recombination and Solution Space Navigation.}
    ...
    \item
    \header{Configuration Spaces of Underconstrained Systems.}
