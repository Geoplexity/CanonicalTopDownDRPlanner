...
\sidenote{A major advantage of the convex Cayley method is that it is completely unaffected when $\delta$ are intervals of values rather than exact values~~\cite{sitharam2010convex}.}
