...
In Section \ref{sec:prelim}, we provide basic definitions in rigidity theory, including what it means for a DR-plan to be complete or optimal. We also elaborate on the new notion of qusecs.
This section is relevant to Examples \ref{materialexample1} and \ref{materialexample2}, where we model them as bar-joint systems and discuss achieving isostaticity, distribution of stresses in self-similar, and other important concepts. \todo{We don't model them as bar-joint... What did this mean originally?}
...
\todo{We intend to make software implementation and videos available upon request and publicly available for the final version of the paper.}
