...
void Program::draw_graph_vertices(
    const vector<gl_obj::pos_vec> &p,
    const vector<gl_obj::pos_vec> &highlight)
{
...
void Program::draw_graph_edges(
    const vector<gl_obj::pos_vec> &e,
    const vector<gl_obj::pos_vec> &highlight,
    const vector<gl_obj::pos_vec> &dashed)
{
...
void Program::_draw_graph_edges_dashed_aux(
    const std::vector<gl_obj::pos_vec> &e,
